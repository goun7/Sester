"""PUGIO panel — basit HTML tablo: kim, kaç çağrı, ne kadar + zincir-durumu.

PRD sürüm-tablosu hafta-2 çıktısı. Marka: brand/pugio-mark.svg gömülü.
"""
...
# brand/pugio-mark.svg'nin gömülü kopyası (tek-dosya dağıtım kültürü)
MARK_SVG = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" width="30" height="30">
  <g stroke="#171717" stroke-width="14" stroke-linecap="round">
    <line x1="55" y1="64" x2="51" y2="136"/>
    <line x1="86" y1="64" x2="88" y2="136"/>
    <line x1="117" y1="64" x2="115" y2="136"/>
    <line x1="147" y1="64" x2="145" y2="136"/>
  </g>
  <line x1="42" y1="100" x2="158" y2="100" stroke="#B8860B" stroke-width="14" stroke-linecap="round"/>
  <path d="M 49 52 L 55 64 L 61 52 L 55 40 Z" fill="#B8860B"/>
</svg>"""

PAGE = """<!DOCTYPE html>
<html lang="tr"><head><meta charset="utf-8">
<title>PUGIO · Panel</title>
<style>
...
<h1>{mark} PUGIO <span class="sub">· AgentMeter paneli · {ts}</span></h1>
...
<h1>{mark} PUGIO <span class="sub">· İnsan-Onay Paneli · {ts}</span></h1>
...
def render_panel(ledger: Any, quota: float) -> str:
    ...
    agent_rows = []
    for a in agents:
        spent_today = ledger.spent_today(a["agent_id"])
