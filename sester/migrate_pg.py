"""SESTER migrate_pg — SQLite→Postgres migrasyonu (hash-koruyan replay).
...
Kullanım:
  python -m sester.migrate_pg --sqlite sester.sqlite3 \
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(prog="sester.migrate_pg",
